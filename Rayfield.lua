...
local Rayfield = useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://77649443597500")[1]
...
repeat
	...
	toDestroy, Rayfield = Rayfield, useStudio and script.Parent:FindFirstChild('Rayfield') or game:GetObjects("rbxassetid://77649443597500")[1]
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if (Settings.KeySystem) then
		...
		if not Passthrough then
			...
			Rayfield.Enabled = false
			local KeyUI = useStudio and script.Parent:FindFirstChild('Key') or game:GetObjects("rbxassetid://77185134246619")[1]
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateButton(ButtonSettings)
            ...
            function DestroyCallback()
                local Success, Response = pcall(ButtonSettings.DestroyCallback)
                if not Success then
                    TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = Color3.fromRGB(85, 0, 0)}):Play()
                    TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
                    Button.Title.Text = "Callback Error"
			...
			Button.InteractSecond.MouseButton1Click:Connect(DoCallback)
            Button.InteractMain.MouseButton1Click:Connect(DoCallback)
            Button.DestroyButton.MouseButton1Click:Connect(DestroyCallback)
